...
import { useCenteredTree } from './helpter.utils'
import Tree from "react-d3-tree";
import * as s from '../../components/colors/colors.js'
import { createStructuredSelector } from 'reselect';
import { selectCollpseNeighborNodes, selectNodeSize, selectOrientation, selectRiskLevel, selectTree } from '../../redux/piquetreeform/piquetreeform.selector';
...
const TreeModel = ({riskLevel, tree, orientation, collapseNeighbornodes}) => {
...
const mapStateToProps = createStructuredSelector({
    ...
    collapseNeighbornodes: selectCollpseNeighborNodes
})
export default connect(mapStateToProps)(TreeModel)